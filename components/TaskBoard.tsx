...
import { Trash2, Hash, Clock, X, Save, Edit2, GripVertical, Maximize2 } from 'lucide-react';
...
const statusConfig = {
  [TaskStatus.TODO]: { label: 'To Do', color: 'border-blue-500/50', bg: 'bg-blue-500/5' },
  [TaskStatus.IN_PROGRESS]: { label: 'In Progress', color: 'border-yellow-500/50', bg: 'bg-yellow-500/5' },
  [TaskStatus.CODE_REVIEW]: { label: 'Review', color: 'border-purple-500/50', bg: 'bg-purple-500/5' },
  [TaskStatus.DONE]: { label: 'Done', color: 'border-green-500/50', bg: 'bg-green-500/5' },
};
            ...
            return (
              ...
              >
                <div className={`p-3 border-b border-gray-800 ${config.bg} flex justify-between items-center`}>
                   <h3 className={`font-mono font-bold text-sm tracking-wider uppercase text-gray-300`}>
                ...
                <div className="md:flex-1 md:overflow-y-auto p-3 space-y-3 custom-scrollbar">
                  {columnTasks.map(task => (
                    <div 
                      ...
                      className="group bg-night-800 border border-gray-700 p-4 rounded hover:border-gray-500 transition-all shadow-sm relative cursor-grab active:cursor-grabbing hover:bg-night-800/80 w-full"
                    >
                      ...
                      <div className="flex gap-2 items-start">
                         ...
                         <div className="flex-1 min-w-0 w-0">
                            ...
                            {task.description && (
                              <p className="text-xs text-gray-500 line-clamp-2 mb-3 font-mono break-words w-full">
